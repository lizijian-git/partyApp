<template>
	...
	<cell>
		...
		>
			...
			<view class="uni-list-item__container" :class="{ 'container--right': showArrow || link, 'flex--direction': direction === 'column', 'reset-padding': resetPadd, 'basepadd-padding': basepadd }">
				<slot name="header">
