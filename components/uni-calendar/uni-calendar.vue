		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			...
			<view class="uni-calendar__box">
				...
				<view class="uni-calendar__weeks">
					...
					<view class="uni-calendar__weeks-day">
						<text class="uni-calendar__weeks-day-text">星期一</text>
					</view>
					<view class="uni-calendar__weeks-day">
						<text class="uni-calendar__weeks-day-text">星期二</text>
					</view>
					<view class="uni-calendar__weeks-day">
						<text class="uni-calendar__weeks-day-text">星期三</text>
					</view>
					<view class="uni-calendar__weeks-day">
						<text class="uni-calendar__weeks-day-text">星期四</text>
					</view>
					<view class="uni-calendar__weeks-day">
						<text class="uni-calendar__weeks-day-text">星期五</text>
					</view>
					<view class="uni-calendar__weeks-day">
						<text class="uni-calendar__weeks-day-text">星期六</text>
					</view>
				</view>
	...
	export default {
		...
		methods: {
			...
			pre() {
				...
				const pre = (this.cale.getDate(this.nowDate.fullDate, -1, 'month'))
				this.setDate(preDate)
				this.$emit('calenPre', pre)
				this.monthSwitch()

			},
			next() {
				const nextDate = this.cale.getDate(this.nowDate.fullDate, +1, 'month').fullDate
				const next = (this.cale.getDate(this.nowDate.fullDate, +1, 'month'))
				this.setDate(nextDate)
				this.$emit('calenNext', next)
				this.monthSwitch()
			},
			setDate(date) {
